    ...
    <div class="wrapper-page">
        <div class="panel-pages login">
            <div class="panel-body">
                ...
                <form method="post" class="form-horizontal m-t-20" action="/login/login_process.php">

                    <div class="form-group">
                        <div class="col-xs-12">
                            <input require name="username" class="form-control input-lg" type="text" required="" placeholder="Username">
                        </div>
                    </div>

                    <div class="form-group">
                        <div class="col-xs-12">
                            <input require name="password" minlength="6" class="form-control input-lg" type="password" required="" placeholder="Password">
                        </div>
                    </div>
